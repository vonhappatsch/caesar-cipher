...
resultadoEncode = encode(135000, "aloha galerezzz!!11!!");

if (resultadoEncode === "itwpi oitmzmhhh!!11!!") {
    console.log("A função de criptografar funcionou! O resultado " + resultadoEncode + " é o esperado.");
} else {
    console.log("Tente novamente, a função de criptografar flopou. O resultado " + resultadoEncode + " não é o esperado ('itwpi oitmzmhhh!!11!!').");
}
